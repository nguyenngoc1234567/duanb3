                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        @if(isset($data['pass']))
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="#" style="color:#ee4c50;text-decoration:underline;"><b style="color: blue"><i>Mật khẩu: </i></b>{{ $data['pass'] }}<br></a></p>
                    @endif
                </td>
                </tr>
                <tr>
                      ...
                      <tr>
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><b></b><br>
                            ...
                            <b><i>Thân Ái!.</i></b><br>
                            <h4><i>Admin: NGUYỄN NHƯ NGỌC (Moto Shop)</i></h4></p>
                          <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="#" style="color:#ee4c50;text-decoration:underline;">Email Liên Hệ: <a href="mailto:ngoc2503pp@gmail.com" style="color:rgb(17,85,204)"
                            target="_blank">ngoc2503pp@gmail.com</a></a></p>
                        </td>
                ...
                <tr>
                  <td style="padding:0;width:50%;" align="left">
                    <p style="margin:0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;color:#ffffff;">
                      &reg; Shein Shop, limited 2022<br/>
                    </p>
                  </td>
